...
export default function AddAdminModal({setShowModal}) {
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/10 backdrop-blur-sm">
              <div className="bg-white rounded-lg py-6 px-12 w-full max-w-md shadow-lg">
                <div className="flex flex-col items-center relative">
                  ...
                  <p className="text-gray-500 text-sm my-4 text-center">A new Admin has been added successfully, a password creation link will be sent to the email added.</p>
