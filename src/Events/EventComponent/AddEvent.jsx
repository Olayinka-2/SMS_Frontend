            ...
            <div className="rounded-xl p-4 bg-white border border-gray-100">
              ...
              <form action="#">
                <div className="flex flex-col gap-5">
                  <div className="flex gap-1">
                    <div className="flex-1 flex flex-col gap-1">
                      ...
                      <input type="text" name="Title" id="EventTitle" placeholder="Event Title"
                        className="border border-gray-300 rounded py-1 px-3 text-sm focus:outline-none"
                      />
                    </div>
                    <div className="flex-1 flex flex-col gap-1">
                  ...
                  <div>
                    <button className="py-1 px-4 bg-green-500 border border-green-500 rounded-sm  cursor-pointer hover:bg-green-600"
