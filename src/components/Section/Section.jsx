  ...
  return (
    <div className='container mx-auto px-6 py-12 bg-white'>
      <div className='grid grid-cols-1 md:grid-cols-3 gap-6 text-center text-green-600 font-bold'>
        <h1 className='text-4xl text-purple-400'>100+ <br className='text-black'/>Parents and Guardian</h1>
        <h1 className='text-4xl text-purple-400'>100+ <br className='text-black'/>Online Contents</h1>
        <h1 className='text-4xl text-purple-400'>25K+ <br className='text-black'/>Graduated Students</h1>
      </div>
      ...
      {/* Team Section */}
      <div className='mt-16 px-2  text-left'>
        <h1 className='text-3xl font-bold text-black'>Team</h1>
        <h5 className='text-1xl text-green-600 mt-2'>Our Top Tutors!</h5>
