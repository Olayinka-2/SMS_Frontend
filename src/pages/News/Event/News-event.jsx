    ...
    <div className="">  
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">  
        ...
        <div className=" mt-6">  
          ...
          <input type="text"  placeholder='Search for events' className='text-[16px] border-gray-600 pr-8.5' style={{ border: '1px solid gray', paddingTop: '5px', paddingBottom: '5px', paddingLeft: '3px'}} />
